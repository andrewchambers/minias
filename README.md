...
The build uses the vendored [PackCC](https://github.com/arithy/packcc)
parser generator in `vendor/packcc`.

or

```
cc -O2 -o vendor/packcc/packcc vendor/packcc/packcc.c
vendor/packcc/packcc -o asm_parser asm.peg
...
- [x] Parser generated by vendored PackCC.
